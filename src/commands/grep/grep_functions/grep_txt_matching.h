#ifndef GREP_TXT_MATCHING_H
#define GREP_TXT_MATCHING_H
...
//Use grep settings to process and match a file line according to state settings, returning 1 if a match
//was found and 0 if none.
